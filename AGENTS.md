...
| **GitHub Package**    | 手动触发 workflow | GitHub Actions | 与 npm 版本同步                      |
...
4. **验证发布结果**
   ...
   - 查看 GitHub Package：https://github.com/sansenjian/qq-music-api/pkgs/npm/qq-music-api
